  ...
  static TypeId
    ...
    .AddAttribute ("PathlossModel",
                   ...
                   MakeTypeIdAccessor (&LteHelper::SetPathlossModelType,
                                       &LteHelper::GetPathlossModelType),
                   MakeTypeIdChecker ())
...
TypeId
LteHelper::GetPathlossModelType () const
{
  NS_LOG_FUNCTION (this);
  return m_pathlossModelFactory.GetTypeId ();
}
...
std::string
LteHelper::GetEnbAntennaModelType ()
{
  NS_LOG_FUNCTION (this);
  return m_enbAntennaModelFactory.GetTypeId().GetName();
}
...
std::string
LteHelper::GetFadingModel () const
{
  NS_LOG_FUNCTION (this);
  return m_fadingModelType;
}
