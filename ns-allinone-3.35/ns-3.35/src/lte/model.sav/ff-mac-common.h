 ...
 * Create struct on RAR msg
 */
struct ueInfo
{
       uint8_t RbAllocation;
       uint8_t tpc;
       uint8_t trgCqiDelta;
       uint8_t maxUlCqi;
       uint8_t trgCqi;
       uint8_t trgSinr;
       uint16_t avgItbs;
       uint64_t lastTpcAppliedTick;
       int8_t delta;
       int8_t phr;
       int8_t remPuschPwr;
       int8_t maxPwrDeltaByPhr;
       int16_t fi;
       int32_t delta_itbs;
       //UE EFFICIENCY
       int16_t delta_sinr;
       uint16_t avg_sinr;
       int8_t gain_diff_per_tb_avg[29];
       uint8_t itbs_index;
       uint8_t mcs_index;
       uint8_t cqi_index;
       bool volteOn;
       ...
       uint8_t maxRb;
       uint16_t sinr_margin_step_up;
       uint16_t sinr_margin_step_down;
       double pwrPerRb;
       bool isPhrAvail;
       bool enable64Qam;
};
